...
(function () {
  ...
  /* 🔒 **글자 ★ 다. 색으로 가른다** — 여기는 **노랑**(`--star`), 본문 중요도는 **파랑**.
     🚨 이모지 ⭐ 를 잠깐 썼다가 되돌렸다 (2026-08-12). 글꼴을 타고 **색을 못 입힌다.**
        문제 저장(즐겨찾기)에 이미 쓰는 노란 별과 같은 모양·같은 색이라 눈에 익다.
     🔑 **어느 별이 무엇인지 한눈에 갈려야 한다** — 노랑은 「기출에 몇 번 나왔나」,
        파랑은 「본문이 중요하다고 표시한 곳」이다. */
  function stars(g) {
    var s = '';
    for (var i = 0; i < g; i++) s += '★';
    return s;
